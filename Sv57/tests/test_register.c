...
/*
 * test_register.c - Sv57 VM Test Registration
 *
...
/* --- Group 1+2: Basic Mapping + Sign Extension (MAP-08~10, SIGN-07) --- */
...
/* --- Group 8+9: Superpage Alignment + Walk (ALIGN-01~02, WALK-03/04/05) --- */
#include "test_superpage.c"

/* --- Group 10: A/D Bit Management (AD-01~05) --- */
#include "test_ad_bits.c"

/* --- Group 11: satp CSR Control (SATP-01/04/07/09) --- */
#include "test_satp.c"
