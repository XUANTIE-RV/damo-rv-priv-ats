...
TEST_REGISTER(test_sv48_align01);
bool test_sv48_align01(void) {
...
TEST_REGISTER(test_sv48_align02);
bool test_sv48_align02(void) {
     ...
     * Install a leaf PTE at L2 with ppn[1:0] != 0.
...
/* ===================================================================
 * Group 9: Multi-level Page Table Walk (WALK-02, WALK-04, WALK-05)
 * =================================================================== */

TEST_REGISTER(test_sv48_walk02);
bool test_sv48_walk02(void) {
    TEST_BEGIN("WALK-02: Sv48 four-level full walk (4KB pages)");
    ...
    TEST_ASSERT("four-level walk read/write succeeds", result == 0);

    pt_pool_reset();
    TEST_END();
}

TEST_REGISTER(test_sv48_walk04);
bool test_sv48_walk04(void) {
...
TEST_REGISTER(test_sv48_walk05);
bool test_sv48_walk05(void) {
