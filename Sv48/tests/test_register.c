...
/*
 * test_register.c - Sv48 VM Test Registration
 *
...
/* --- Group 1+2: Basic Mapping + Sign Extension (MAP-05~07, SIGN-05) --- */
...
/* --- Group 8+9: Superpage Alignment + Walk (ALIGN-01~02, WALK-02/04/05) --- */
#include "test_superpage.c"

/* --- Group 10: A/D Bit Management (AD-01~05) --- */
#include "test_ad_bits.c"

/* --- Group 11: satp CSR Control (SATP-01/03/06/07/09) --- */
#include "test_satp.c"
