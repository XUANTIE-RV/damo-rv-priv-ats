...
/*
 * test_helpers.h - Common helpers for the Smstateen test suite.
 *
...
#ifndef SMSTATEEN_TEST_HELPERS_H
#define SMSTATEEN_TEST_HELPERS_H
 ...
 * Only compiled when ENABLE_HYP is set.
 * =================================================================== */
...
#endif /* SMSTATEEN_TEST_HELPERS_H */
